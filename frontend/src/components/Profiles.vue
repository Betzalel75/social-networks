    ...
    <div class="forumPage">
      <div class="container" x-data="{ rightSide: false, leftSide: false }">
        <div class="left-side" :class="{ active: leftSide }">
          ...
          <div class="logo" style="left: 1%; font-size: 24px">
            {{ nickNameProfile.toUpperCase() }}
          </div>
            ...
            <div class="composents">
              <div class="profil-description">
                <div class="section-follow">
                  <div class="profile-name" :data-userId="localID">
                    {{ nickNameProfile }}
                  </div>
              ...
              <div class="profil-follow">
                <div class="btn-follow">
                  <button :class="'status-share follow-' + idUser" @click="followedUser(idUser, $event)">
...
export default {
  ...
  components: { Posts, Users, Notifications, Locked },
  ...
  computed: {
    ...
    datas() {
      return this.$store.getters.postsUsers;
    },
    avatar() {
      return this.$store.getters.avatar;
    },
    avatarProfile() {
      return this.$store.getters.avatarInvite;
    },
    nickNameProfile() {
      return this.$store.getters.nickNameProfile;
    },
    idUser() {
  ...
  methods: {
    ...
    go() {
      ...
      this.verification();
      this.fetchData("/getDataProfiles?all", this.$store.getters.idUser)
        .then((response) => {
    ...
    async getNumbersFollowers() {
      const data = await this.fetchData("/getFollowersInvite", this.$store.getters.idUser);
